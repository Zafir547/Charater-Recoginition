...
class Ui_MainWindow(object):
    ...
    def trainingFunction(self):
        ...
        training_set = train_datagen.flow_from_directory('E:/AI Pantech Solution\15. Day 15/Character_Recognition/Dataset/train',
                                                         target_size = (128, 128),
                                                         batch_size = 8,
        ...
        test_set = test_datagen.flow_from_directory('E:/AI Pantech Solution/15. Day 15/Character_Recognition/Dataset/val',
                                                    target_size = (128, 128),
                                                    batch_size = 8,
                                                    class_mode = 'categorical')
